...
function renderLoginGate(props: LoginGateProps) {
  ...
  const faviconSrc = controlUiPublicAssetPath("opencraw-mark.png", basePath);
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="OpenCraw" />
          <div class="login-gate__title">OpenCraw Control</div>
