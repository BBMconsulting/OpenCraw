...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "OpenCraw was updated in the background. Reload to get the latest panel.",
    reloading: "Reloading…",
    retry: "Retry",
  },
  nodes: {
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by OpenCraw.",
    cleanNow: "Clean up now",
    cleanupTitle: "Cleanup",
    cleanupSubtitle:
      "OpenCraw periodically removes old worktrees to free disk space. Tune how aggressively cleanup runs.",
  ...
  modelSetup: {
    ...
    intro:
      "OpenCraw reuses AI access you already have — a CLI login, an API key, or a provider sign-in.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older OpenCraw version",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "OpenCraw creates a verified pre-import backup before copying memory.",
    confirmImport: "Import memory",
    disconnected: "Connect to the gateway to import memory.",
    title: "Import assistant memory",
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into OpenCraw.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "OpenCraw found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up OpenCraw.",
    },
  },
  custodian: {
    title: "OpenCraw",
    ...
    placeholder: "Message OpenCraw…",
    sensitivePlaceholder: "Enter sensitive value…",
    sensitiveReply: "Sensitive reply sent",
    send: "Send",
    thinking: "OpenCraw is thinking",
    earlier: "Earlier",
    requestFailed: "OpenCraw could not reply. Try again.",
    connectionChanged: "The Gateway connection changed. Retry to continue this setup.",
    sessionRestarted:
      "{error} OpenCraw started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with OpenCraw.",
    history: {
      button: "History",
      ...
      requestFailed: "OpenCraw could not load change history.",
      loadMore: "Load more",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Discover a featured plugin or search ClawHub to extend OpenCraw.",
    ...
    optionalCapability: "Optional OpenCraw capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  aboutPage: {
    productName: "OpenCraw",
    tagline: "An OpenClaw-compatible AI gateway and assistant.",
    waveHello: "Greet CrawCraw",
    linksLabel: "OpenCraw and upstream OpenClaw resources",
    linkWebsite: "Upstream website",
    linkDocs: "Upstream docs",
    linkGitHub: "OpenCraw source",
    linkDiscord: "Upstream Discord",
    linkX: "Upstream X",
    linkChangelog: "Upstream changelog",
    license: "OpenCraw is based on OpenClaw. OpenClaw © 2026 OpenClaw Foundation — MIT License.",
  ...
  appsPage: {
    heroTitle: "Upstream OpenClaw apps",
    heroTagline:
      "Official OpenClaw companion apps connect to compatible gateways; community plugins extend what your agent can do.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "OpenCraw reviews corrections and substantial completed runs, then drafts skill proposals for this board. It spends extra background tokens and drafts arrive as pending proposals.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Restart the Gateway after updating OpenCraw so it serves the current protocol.",
      },
      network: {
  ...
  chat: {
    ...
    catalog: {
      ...
      openInOpenClaw: "Open in OpenCraw",
    ...
    catalogOpenTargetViewer: "OpenCraw viewer",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenCraw kept your local versions and applied the other cloud changes. Inspect the staged result or take its version for a conflicted path.",
      ...
      commandsUnavailable:
        "This filename contains terminal control characters, so OpenCraw will not build a copyable shell command for it. Inspect the staged ref directly and enter the path manually with care.",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what OpenCraw should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what OpenCraw should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what OpenCraw should do...",
      repeat: "Repeat",
